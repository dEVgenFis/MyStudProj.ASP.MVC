...
* чувствительные данные VPS (IP-адрес, имя пользователя, пароль доступа, строка подключения к БД) скрыты в <b>GitHub Secrets</b> с последующей подстановкой в CI/CD, что позволяет сохранить их конфиденциальность
...
* реализация разделов "Избранное", "Сравнение", "Корзина", "Оформление заказа", "Поиск/фильтрация"
